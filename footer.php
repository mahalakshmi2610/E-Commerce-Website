            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <h4 class="font-rubik font-size-20">Set Trend</h4>
                        <p class="font-size-14 font-rale text-white-50">Set Trend is your ultimate destination for a diverse and elegant collection of kurtis specially curated for the modern, fashion-forward woman.</p>
                    </div>
